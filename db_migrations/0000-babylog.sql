...
CREATE TABLE `events` (
    ...
    `feed_type` tinyint(1) default 0,
    `boob_side` tinyint(1) default 0,
    `amount` decimal(10,2) DEFAULT NULL,
    `secondary_amount` decimal(10,2) DEFAULT NULL,
    `units` tinyint(1) default 0,
    `stop_time` datetime DEFAULT NULL,
    `time_minutes` int(11) DEFAULT NULL,
    `vitamin_d` tinyint(1) default 0,
    `formula_feed` tinyint(1) default 0,
    `left_amount` decimal(10,2) DEFAULT NULL,
    `right_amount` decimal(10,2) DEFAULT NULL,   
    `diaper_type` int(11) DEFAULT 0, 
    `content` varchar(512),
...
CREATE TABLE `users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `default_account_id` int(11),
  `default_kid_id` int(11),
